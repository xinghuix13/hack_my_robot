...
output_file_path = rospkg.RosPack().get_path('hack_my_robot')+"/saved_path/scan_positions.csv"
waypoints = []
...
# Definition of the different states for the State Machine
class GetPath(State):
    def __init__(self):
    ...
    def execute(self, userdata):
        ...
        # for loading the saved poses from hack_my_robot/saved_path/poses.csv
        ...
        rospy.loginfo("To start following waypoints and save them: 'rostopic pub -1 /path_ready std_msgs/Empty'")
        rospy.loginfo("OR")
        rospy.loginfo("To start following saved waypoints: 'rostopic pub /start_journey std_msgs/Empty'")
